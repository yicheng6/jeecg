...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tGowinClassController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="xzbdm" name="xzbdm" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="xzbmc" name="xzbmc" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
							<span class="Validform_checktip"></span>
